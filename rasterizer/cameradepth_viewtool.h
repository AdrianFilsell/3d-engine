...
class cameradepth_viewtool:public viewtool
{
public:
	cameradepth_viewtool(CrasterizerView *pV):viewtool(pV){}
	virtual ~cameradepth_viewtool(){}

	virtual type gettype( void ) const {return t_cameradepth;}
